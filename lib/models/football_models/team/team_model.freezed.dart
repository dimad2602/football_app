...
class _$TeamModelImpl implements _TeamModel {
  ...
  @override
  String toString() {
    return 'TeamModel(id: $id, uid: $uid, location: $location, name: $name, abbreviation: $abbreviation, displayName: $displayName, shortDisplayName: $shortDisplayName, isActive: $isActive, logos: $logos, isNational: $isNational)';
  }
